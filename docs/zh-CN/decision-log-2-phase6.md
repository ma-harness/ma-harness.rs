# ma-harness.rs — 决策档案 (Decision Log) — Part 2 — Phase 4-6 (HTTP + Streaming)

> 项目内部代号: **ma-harness.rs** (Rust 重写 DeepSeek Harness)
> 文档目的: 把分散在多轮对话里的关键决策落成'宪法', 任何后续修改都要回头对账

[**总目录**](decision-log.md) | 本文件: **Part 2 — Phase 4-6 (HTTP + Streaming)**
...
**暂缓 pyo3, 等 gRPC binding 跑 3-6 月看业务反馈** (详见 [pyo3-evaluation.md](./reports/pyo3-evaluation.md))
