...
[English](../en/tech-stack.md) | [简体中文](tech-stack.md)
...
> **备注**: P12 阶段 (Day 101+1) salvo 已从 0.79 升到 0.93 (见 decision-log §20), 最新跑分用 0.95.2 (见 decision-log §21).
...
> **备注**: P10-7 阶段, `prometheus` 0.13 通过 `ma-harness-server` 接入, 暴露 `/v1/metrics` (text format).
...
> **备注**: P10-1.6 阶段, `landlock` 0.4 通过 `ma-harness-sandbox` 接入 (跨平台: Linux landlock / macOS seatbelt / 其他 stub).
...
| 2026-08-19 | 备注 salvo 0.79 → 0.93 / 0.95.2 升级 (见 decision-log §20 / §21) |
| 2026-08-20 | 加 P10-1.6 landlock / P10-7 prometheus 接入备注 (P10) |
