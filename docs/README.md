...
🌐 **i18n convention**: [docs/i18n.md](i18n.md) — bilingual (English / Simplified Chinese) file naming and translation rules.
...
- [Decision log](decision-log.md) — "why was it designed this way?"
...
- [Decision log](decision-log.md) — historical design decisions

### Performance / optimization (running dsh Terminal Bench)

- [P11-2 dsh real snapshot benchmark](dsh-benchmark-report.md) — 9/9 = 100% equivalent
- [P11 roadmap](roadmap-phase-11.md) — 9 follow-up tasks (P11-3 to P11-10)
- [P11 final report](p11-final-report.md) — P11 wrap-up + dsh comparison
- [Benchmark design](benchmark-design.md) — bench methodology
- [Week 11 benchmark report](benchmark-report-week11.md) — perf baseline
- [Week 11 conformance report](conformance-report-week11.md) — conformance baseline

### History / decision tracing

- [Decision log](decision-log.md) — § 1-39 historical design decisions
- [P11 baseline report](p11-baseline-report.md) — dsh_synthetic 28.6% → 100%
- [P11 final report](p11-final-report.md) — P11 wrap-up
- [P12 final report](p12-final-report.md) — P12 wrap-up (release / stability / docs / PyPI)
- [Roadmap Phase 7](roadmap-phase-7.md) — Phase 7-10 (Code Mode / TUI / ACP / Vision)
- [Roadmap Phase 11](roadmap-phase-11.md) — P11 (dsh parity)
...
- [P11-2 dsh real snapshot benchmark](dsh-benchmark-report.md)
- [P11 baseline report](p11-baseline-report.md)
- [P11 final report](p11-final-report.md)
- [P12 final report](p12-final-report.md)
- [Week 11 conformance report](conformance-report-week11.md)
- [Week 11 benchmark report](benchmark-report-week11.md)
...
- [PyO3 evaluation](pyo3-evaluation.md) — Python binding technology choice
- [Code Mode deferred](code-mode-deferred.md) — wasm mode postponement decision
...
- [OpenAPI spec (Chinese)](api/openapi.zh-CN.json) — REST API surface (简体中文)

### Decisions

- [Decision log](decision-log.md) — § 1-39 complete record
...
2. **Modifying ma-harness internals**: [Architecture map](ma-harness-arch-map.md) → [Conformance design](conformance-design.md) → [Decision log](decision-log.md)
3. **Running Terminal Bench**: [dsh benchmark report](dsh-benchmark-report.md) → [P11 final report](p11-final-report.md) → [P12 final report](p12-final-report.md)
...
- The [decision log](decision-log.md) is the single source of truth; check it before changing design.
