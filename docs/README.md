...
- [P11-2 dsh real snapshot benchmark](zh-CN/dsh-benchmark-report.md) — 9/9 = 100% equivalent
- [P11 roadmap](zh-CN/roadmap-phase-11.md) — 9 follow-up tasks (P11-3 to P11-10)
- [P11 final report](zh-CN/p11-final-report.md) — P11 wrap-up + dsh comparison
- [Benchmark design](benchmark-design.md) — bench methodology
- [Week 11 benchmark report](zh-CN/benchmark-report-week11.md) — perf baseline
- [Week 11 conformance report](zh-CN/conformance-report-week11.md) — conformance baseline

### History / decision tracing

- [Decision log](zh-CN/decision-log.md) — § 1-39 historical design decisions
- [P11 baseline report](zh-CN/p11-baseline-report.md) — dsh_synthetic 28.6% → 100%
- [P11 final report](zh-CN/p11-final-report.md) — P11 wrap-up
- [P12 final report](zh-CN/p12-final-report.md) — P12 wrap-up (release / stability / docs / PyPI)
- [Roadmap Phase 7](zh-CN/roadmap-phase-7.md) — Phase 7-10 (Code Mode / TUI / ACP / Vision)
- [Roadmap Phase 11](zh-CN/roadmap-phase-11.md) — P11 (dsh parity)
...
- [P11-2 dsh real snapshot benchmark](zh-CN/dsh-benchmark-report.md)
- [P11 baseline report](zh-CN/p11-baseline-report.md)
- [P11 final report](zh-CN/p11-final-report.md)
- [P12 final report](zh-CN/p12-final-report.md)
- [Week 11 conformance report](zh-CN/conformance-report-week11.md)
- [Week 11 benchmark report](zh-CN/benchmark-report-week11.md)
...
- [PyO3 evaluation](zh-CN/pyo3-evaluation.md) — Python binding technology choice
- [Code Mode deferred](zh-CN/code-mode-deferred.md) — wasm mode postponement decision
...
3. **Running Terminal Bench**: [dsh benchmark report](zh-CN/dsh-benchmark-report.md) → [P11 final report](zh-CN/p11-final-report.md) → [P12 final report](zh-CN/p12-final-report.md)
